...
int main() {
   ...
   string ibase = "/home/miiya369/data/pacs-cs/analysis_20180129/"+quark+"_quark/ens1/bin";
   string obase = "/home/miiya369/data/pacs-cs/analysis_20180129/"+quark+"_quark/ens1/LxN/pot";
   ...
   /// For construct the leading order potential (e.g. Sigma N) ///
   {
      ...
      for (int itime=min_time; itime<=max_time; itime++) {
         ...
         for (int ich=0; ich<4; ich++) {
            ipotC[ich].input_data_bin(obase+"/Pot."+ich_str_C[ich]+".t"+time_str+".bin_size"+Bsize_str);
            opotC[ich].mem_alloc(ipotC[ich].Ndata());
         }
         for (int ich=0; ich<2; ich++) {
            ipotT[ich].input_data_bin(obase+"/Pot."+ich_str_T[ich]+".t"+time_str+".bin_size"+Bsize_str);
